...
\033[1;32m 
        ...
        | $$  \$$$ \$$  \$$\| $$  | $$
         \$$   \$$  \$$$$ $$ \$$   \$$
\033[1;93m--------------------------------------------------
\033[1;37m[-] AUTHOR    :\033[1;32m MR-Nihal&Alishba Queen
\033[1;37m[-] GITHUB    :\033[1;32m Alishba Queen&Nihalhacker
...
def menu_apikey():
  ...
  os.system(" clear")                          
  print("""\033[1;37m  
        \033[1;32m     d8b   db .d888b.   .d8b.  
  \033[1;32m           888o  88 8P   8D  d8' `8b 
\033[1;32m             88V8o 88 `Vb d8'  88ooo88 
 \033[1;32m            88 V8o88  d88C dD 88~~~88 
\033[1;32m             88  V888 C8' d8D  88   88 
 \033[1;32m            VP   V8P `888P Yb YP   YP  
 \033[1;93m=================================================
\033[1;37m[-] AUTHOR    :\033[1;32m MR-Nihal& Alishba Queen
\033[1;37m[-] GITHUB    :\033[1;32m Alishba Queen_& Nihal
\033[1;37m[-] WhatsApp  :\033[1;32m +92 318 8944635
...
==================================================
 \33[37;41m\t OWNER MR-Nihal& Alishba Queen\33[0;m
\033[1;93m=================================================
...
==================================================   """)
  ...
  os.system('xdg-open https://wa.me/+92318 8944635')
  print("");time.sleep(2)
  print("\x1b[1;97m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get(https://github.com/Nihalhacker224/main/Nihalhacker.txt").text
    if id in httpCaht:
...
def tnx():
  ...
  print("\x1b[1;97m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/Nihalhacker224/Trick2/tree/main").text
    if id in httpCaht:
      print("\033[1;97m   YOUR TOKEN APROVED ðŸ¥€ ");time.sleep(2)
      msg = str(os.geteuid())
      time.sleep(0.5)
      ...
      print("    Send payment to Admin and get aproval"); time.sleep(2)
      os.system('xdg-open https://wa.me/+923188944635')
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
